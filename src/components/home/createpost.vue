      ...
      <form @submit.prevent="post">
        ...
        <div class="relative">
          <textarea required v-model="stuff.description"
            class="rounded-lg m-2 w-buttonr h-64 text-lg outline-blue-500 outline-8 text-start resize-none pb-8"
            placeholder="Description" maxlength="2000"></textarea>
          <span class="text-black absolute bottom-4 right-4">{{ stuff.description.length }} / 2000</span>
        </div>
        <button
